...
const teamMembers = [
  ...
  { id: 5, name: "Alex Chen", role: "Backend_Dev", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "online" },
  { id: 6, name: "Priya Sharma", role: "Frontend_Dev", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "busy" },
  { id: 7, name: "Vikram Singh", role: "Data_Scientist", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "away" },
  { id: 8, name: "Anjali Patel", role: "Mobile_Dev", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "online" },
  { id: 9, name: "Rahul Kumar", role: "Security_Eng", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "busy" },
  { id: 10, name: "Sneha Gupta", role: "QA_Engineer", image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "away" },
  { id: 11, name: "Arjun Nair", role: "Cloud_Arch", image: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "online" },
  { id: 12, name: "Kavita Rao", role: "Product_Manager", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "busy" },
  { id: 13, name: "Deepak Joshi", role: "AI_Engineer", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "away" },
  { id: 14, name: "Pooja Mehta", role: "UX_Researcher", image: "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "online" },
  { id: 15, name: "Suresh Reddy", role: "DevOps_Lead", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "busy" },
  { id: 16, name: "Nisha Agarwal", role: "FullStack_Dev", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=2787&auto=format&fit=crop", socials: { linkedin: "#", github: "#", instagram: "#" }, status: "away" },
];
      ...
      <div className="flex items-center gap-5 z-10">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="hidden md:inline-flex px-2 py-0.5 rounded text-[10px] font-mono bg-emerald-100 text-emerald-800 dark:bg-emerald-500/10 dark:text-blue-500 border border-emerald-200 dark:border-emerald-500/20">ROOT_ADMIN</span>
          </div>
    ...
    <div className="absolute bottom-0 left-0 w-full bg-neutral-50 dark:bg-neutral-950 border-t border-neutral-200 dark:border-neutral-800 p-4 z-20">
      <div className="flex justify-between items-start mb-2">
        <div>
          ...
          <p className="text-blue-600 dark:text-blue-500 text-xs font-mono mt-0.5">{`> ${member.role}`}</p>
        </div>
...
export default function CoreTeamFull() {
  return (
    <section className="w-full bg-neutral-50 dark:bg-neutral-950 py-24 px-4 md:px-8" aria-label="Core team">
      <div className="max-w-[1230px] mx-auto">
        <div className=" mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-neutral-200 dark:border-neutral-800 pb-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Cpu size={20} className="text-blue-600 dark:text-blue-500" aria-hidden="true" />
              <span className="font-mono text-blue-600 dark:text-blue-500 text-sm">/system_architecture/core</span>
            </div>
